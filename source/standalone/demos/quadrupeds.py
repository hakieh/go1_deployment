...
from omni.isaac.lab_assets.unitree import UNITREE_A1_CFG, UNITREE_GO1_CFG, UNITREE_GO2_CFG,BRUCE_CFG,G1_CFG # isort:skip
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # -- Robot
    bruce = Articulation(G1_CFG.replace(prim_path="/World/Origin8/Robot"))
